#pragma checksum "C:\Users\muhammetkaya\source\repos\SelfservisControlPanel\SCPDashboard\Views\Log\Index.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "5f16a31e7d702a1f503892463309eb9c37f3dbd3"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"5f16a31e7d702a1f503892463309eb9c37f3dbd3", @"/Views/Log/Index.cshtml")]
...
#line 66 "C:\Users\muhammetkaya\source\repos\SelfservisControlPanel\SCPDashboard\Views\Log\Index.cshtml"
    ...
    .Build(columns =>
    {
        ...
        columns.Add(model => model.Tarih.ToString("dd/MM/yyyy")).Formatted("{0:d}").Titled("Tarih").Filterable(false).Sortable(true);
...
#nullable disable
    ...
    <script>
        ...
        $(""#StudentTable"").on(""click"", ""a.detay"", function (e) {
            ...
            $.ajax({
                ...
                method: ""GET"",
                dataType: ""json"",
                url: ""selfservislogs/personel/getSms"",
 ...
 ");
        ...
        document.addEventListener(""gridconfigure"", e => {
            ...
            // Save configuration to a cookie/local storage/backend");
