...
var KTApexChartsDemo = function () {
	...
	var _demo12 = function () {
		let risky = document.getElementById("risky").value;
		let riskless = document.getElementById("riskless").value;
		let errorcode = document.getElementById("errorcode").value;
		const apexChart = "#chart_12";
		var options = {
			series: [parseInt(riskless), parseInt(errorcode), parseInt(risky)],
			chart: {
				width: 380,
				type: 'pie',
			},
			labels: ['Saglikli Personel', 'Hes Kodu Hatali', 'Riskli Personel'],
			responsive: [{
				breakpoint: 480,
				options: {
					chart: {
	...
	var _demo15 = function () {
		let vaccinated = document.getElementById("vaccinated").value;
		let unvaccinated = document.getElementById("unvaccinated").value;
		const apexChart = "#chart_vaccinated";
		var options = {
			series: [parseInt(vaccinated), parseInt(unvaccinated)],
			chart: {
				width: 380,
				type: 'pie',
			},
			labels: ['Asilari Yapildi', 'Asilari Yapilmadi'],
			responsive: [{
				breakpoint: 480,
				options: {
					chart: {
